...
import { X, User, Building2, Eye, EyeOff, AlertCircle } from 'lucide-react';
...
export const SignInModal = ({ isOpen, onClose, onLogin }: SignInModalProps) => {
  ...
  const handleForgotPassword = () => {
    // Dummy handler - in a real app, this would send a reset email
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50 backdrop-blur-sm">
      <div className="w-full max-w-md">
        <div className="relative bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-2xl rounded-2xl overflow-hidden">
          {/* Brand gradient top border */}
          <div className="h-1 w-full bg-gradient-to-r from-orange-300/40 via-rose-300/40 to-amber-300/40"></div>

          <div className="p-6">
            {/* Close Button */}
            <button
              onClick={onClose}
              className="absolute top-4 right-4 p-2 text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors duration-200 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <button
                  ...
                  aria-label="Select HR manager role"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-colors duration-200 ${
                    fieldErrors.email
                      ? 'border-red-500 focus:ring-red-500'
                      : 'border-gray-300 dark:border-gray-600 focus:ring-[#e99f75]'
                  }`}
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-3 py-2 pr-10 border rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition-colors duration-200 ${
                ...
                <button
                  ...
                  className="mt-2 text-sm text-[#e99f75] hover:text-orange-600 dark:hover:text-orange-400 transition-colors duration-200"
                >
                  Forgot password?
                </button>
              </div>
              ...
              <div className="relative group">
                <button
                  ...
                  aria-label="View demo credentials"
                >
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-4 bg-gradient-to-r from-[#e99f75] to-orange-600 hover:from-orange-600 hover:to-orange-700 disabled:from-gray-400 disabled:to-gray-500 text-white font-medium rounded-lg transition-all duration-200 disabled:cursor-not-allowed transform hover:scale-105 disabled:transform-none shadow-lg hover:shadow-xl"
